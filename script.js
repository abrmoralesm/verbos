document.addEventListener("DOMContentLoaded", () => {
  ...
  function checkVerb(verb, index) {
    ...
    if (verb.infinitive === "to be") {
      ...
      meaningInput = document.querySelector(
        `#${verb.infinitive}-meaning-input`
      );
    }
    ...
    if (pastInput && meaningInput) {
      ...
      if (pastValue === verb.pastSimple && meaningValue === verb.meaning) {
        ...
        results[
          index
        ].innerHTML = ` <span  class='parpadeo'>you're really stupid 😿</span> <span class='respuesta'>P.S: ${verb.infinitive} // M: ${verb.pastSimple}</span>`;
  ...
  function resetResults() {
    ...
    const pastInputs = document.querySelectorAll(
      "input[type='text'][id$='-past-input']"
    );
    const meaningInputs = document.querySelectorAll(
